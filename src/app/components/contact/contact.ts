    ...
    <section class="py-24 relative overflow-hidden px-6 min-h-[600px] flex items-center">
      ...
      <div class="max-w-4xl mx-auto w-full relative z-10 text-center">
        ...
        <div class="flex flex-col gap-4 w-full max-w-lg mx-auto">
            <!-- WhatsApp -->
            <a href="#" class="group relative overflow-hidden rounded-full h-16 bg-green-600 transition-all hover:bg-green-700 hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(22,163,74,0.4)] flex items-center justify-center gap-3">
              ...
              <span class="font-bold text-white text-lg">WhatsApp</span>
            </a>

            <!-- Call -->
            <a href="#" class="group relative overflow-hidden rounded-full h-16 bg-white transition-all hover:bg-slate-200 hover:-translate-y-1 flex items-center justify-center gap-3">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6 text-slate-900 group-hover:scale-110 transition-transform">
                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
              </svg>
              <span class="font-bold text-slate-900 text-lg">Llamar Ahora</span>
            </a>

            <!-- Email -->
            <a href="#" class="group relative overflow-hidden rounded-full h-16 bg-transparent border border-white/20 transition-all hover:bg-white/10 hover:border-white/30 hover:-translate-y-1 flex items-center justify-center gap-3">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6 text-white group-hover:scale-110 transition-transform">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
              </svg>
              <span class="font-bold text-white text-lg">Enviar Correo</span>
            </a>
        </div>
