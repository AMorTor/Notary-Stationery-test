    ...
    <section class="py-24 relative overflow-hidden px-6 min-h-[600px] flex items-center">
      ...
      <div class="max-w-4xl mx-auto w-full relative z-10 text-center">
        ...
        <div class="flex flex-col gap-4 w-full max-w-full mx-auto" appScrollReveal>
            ...
            <!-- Call -->
            <a [href]="'tel:' + contact.phone.number" class="group relative overflow-hidden rounded-full h-16 bg-white transition-all hover:bg-slate-200 hover:-translate-y-1 flex items-center justify-center gap-3">
            ...
            <!-- Email -->
            <a [href]="'mailto:' + contact.email.address + '?subject=Solicitud de Información'" class="group relative overflow-hidden rounded-full h-16 bg-transparent border border-white/20 transition-all hover:bg-white/10 hover:border-white/30 hover:-translate-y-1 flex items-center justify-center gap-3">
