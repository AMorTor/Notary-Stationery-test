    ...
    <section class="min-h-screen pt-32 pb-20 px-6 bg-slate-950 text-white">
      <div class="max-w-4xl mx-auto space-y-20">
        ...
        <div class="text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6">Sobre Nosotros</h1>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-3xl font-bold text-blue-400 mb-4">Misión</h2>
            ...
            <div class="h-64 bg-slate-900 rounded-xl border border-white/5 flex items-center justify-center text-slate-600">
                [Icono Misión]
            </div>
        </div>
        ...
        <!-- Vision -->
        <div class="grid md:grid-cols-2 gap-12 items-center">
             <div class="h-64 bg-slate-900 rounded-xl border border-white/5 flex items-center justify-center text-slate-600 order-2 md:order-1">
                [Icono Visión]
            </div>
            <div class="order-1 md:order-2">
                <h2 class="text-3xl font-bold text-violet-400 mb-4">Visión</h2>
                <p class="text-slate-300 leading-relaxed">
        ...
        <div>
            ...
            <div class="grid sm:grid-cols-3 gap-6">
                <div class="p-6 bg-slate-900 rounded-xl border border-white/5 text-center">
                    <h3 class="text-xl font-bold text-blue-300 mb-2">Seguridad</h3>
                    <p class="text-slate-400 text-sm">Protección absoluta en cada folio.</p>
                </div>
                <div class="p-6 bg-slate-900 rounded-xl border border-white/5 text-center">
                    <h3 class="text-xl font-bold text-blue-300 mb-2">Elegancia</h3>
                    <p class="text-slate-400 text-sm">Estética impecable en cada detalle.</p>
                </div>
                <div class="p-6 bg-slate-900 rounded-xl border border-white/5 text-center">
                    <h3 class="text-xl font-bold text-blue-300 mb-2">Compromiso</h3>
